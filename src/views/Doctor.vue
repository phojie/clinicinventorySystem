    ...
    >
      <v-layout justify-center class="mt-3 mr-1">
        <v-avatar color="white" size="100">
          <img src="https://img.icons8.com/color/1600/000000/doctor.png">
        </v-avatar>
      </v-layout>
      <v-layout justify-center class="mt-4 mr-1">
        <span class="title white--text"> Doctor Panel</span>
      </v-layout>
      ...
      <v-list dense class="">
        ...
        <v-subheader class="mt-3 green--text">MANAGE</v-subheader>
         <v-btn  class="textNone caption transparent" exact-active-class="green"  depressed block to="/doctorAdmission">
          ...
          <v-btn  class="textNone caption transparent" exact-active-class="green"  depressed block to="/doctorRequest">
          <v-list-tile-action>
            <v-avatar tile size="21">
              <img src="https://img.icons8.com/ios/50/ffffff/repository-filled.png">
            </v-avatar>
          </v-list-tile-action>
          <v-list-tile-content>
            <v-list-tile-title>
