  ...
  computed: {
    ...
    doneAppointments() {
     ...
     myDone() {
      ...
      var filter = _.filter(this.listofAppointments,{'doctor': this.accountDetails.fn+' '+this.accountDetails.ln, 'status': 'Done'})
      // var filter = _.filter(this.listofAppointments,'doctor')
      // console.log("​myRequest -> filter", filter)
      return filter
    },
    myAdmitted() {
      var filter = _.filter(this.listofAppointments,{'doctor': this.accountDetails.fn+' '+this.accountDetails.ln, 'status': 'Admitted'})
    ...
    myRequest() {
      var filter = _.filter(this.listofAppointments,'doctor')
      // var filter = _.filter(this.listofAppointments,{'doctor': this.accountDetails.fn+' '+this.accountDetails.ln, 'status': 'Pending'})
      // var filter = _.filter(this.listofAppointments,'doctor')
      // console.log("​myRequest -> filter", filter)
      return filter
    },
